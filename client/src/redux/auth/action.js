...
export const registerUser = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("http://localhost:4500/users/register", userData, config);
    console.log(data);
...
export const loginUser = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("http://localhost:4500/users/login", userData, config);
    console.log(data);
    dispatch({
